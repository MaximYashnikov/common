...
function suitesChart() {
	...
	var data = [
		{ value: passed, color: '#00af00', highlight: '#32bf32', label: 'Пройден' },
		{ value: failed, color:'#F7464A', highlight: '#FF5A5E', label: 'Провален' },
		{ value: $('.suite-result.error').length, color:'#ff6347', highlight: '#ff826b', label: 'Ошибка' },
		{ value: $('.suite-result.inconclusive').length, color: '#FDB45C', highlight: '#FFC870', label: 'Предупреждение' },
		{ value: $('.suite-result.skipped').length, color: '#1e90ff', highlight: '#4aa6ff', label: 'Пропущен' }
	];
...
function testsChart() {
    ...
    if ($('body.summary').length > 0) {
        ...
        data = [
            { value: passed, color: '#00af00', highlight: '#32bf32', label: 'Пройден' },
            { value: failed, color:'#F7464A', highlight: '#FF5A5E', label: 'Провален' },
            { value: others, color: '#1e90ff', highlight: '#4aa6ff', label: 'Другое' }
        ];
        ...
        data = [
            { value: passed, color: '#00af00', highlight: '#32bf32', label: 'Пройден' },
            { value: failed, color:'#F7464A', highlight: '#FF5A5E', label: 'Провален' },
            { value: errors, color:'#ff6347', highlight: '#ff826b', label: 'Ошибка' },
            { value: inconclusive, color: '#FDB45C', highlight: '#FFC870', label: 'Предупреждение' },
            { value: skipped, color: '#1e90ff', highlight: '#4aa6ff', label: 'Пропущен' }
        ];
